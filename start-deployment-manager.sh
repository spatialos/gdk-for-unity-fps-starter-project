...
spatial cloud launch "deployment_manager_${ASSEMBLY_POSTFIX}" deployment_manager_launch.json "deployment_manager_${ASSEMBLY_POSTFIX}" --snapshot=snapshots/empty.snapshot
