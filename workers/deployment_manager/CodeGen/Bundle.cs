...
namespace CodeGen.BundleModel
{
    ...
    public class ValueTypeReference
    {
        ...
        public ValueType ValueTypeSelector
        {
            get
            {
                if (Primitive != PrimitiveType.Invalid) return ValueType.Primitive;

                if (Type != null) return ValueType.Type;

                if (Enum != null) return ValueType.Enum;
