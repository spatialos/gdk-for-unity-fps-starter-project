    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                fixed3 node_254 = (fixed3(2,0,2)+i.posWorld.rgb).rgb;
...
////// Specular:
                ...
                float3 diffuseColor = (_Colour_Tint.rgb*_T_Main_var.r); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float roughness = 1.0 - (_T_Main_var.g*_T_Main_var.g);
