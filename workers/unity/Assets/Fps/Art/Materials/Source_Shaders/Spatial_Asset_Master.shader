    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                fixed node_3445 = ((node_1171*-0.2+0.1)+((distance(float2(i.posWorld.r,i.posWorld.b),float2(_WorldSpaceCameraPos.r,_WorldSpaceCameraPos.b))+21.0)/lerp(_LocalClipDistance,_GlobalClipDistance,_OverrideClipDistanceToGlobals)));
