    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                fixed2 node_926 = ((float2(i.posWorld.r,i.posWorld.b)*0.25)+node_3436);
...
///////// Gloss:
                fixed4 _T_Main_var = tex2D(_T_Main,TRANSFORM_TEX(node_926, _T_Main));
