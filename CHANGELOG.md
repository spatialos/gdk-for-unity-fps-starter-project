...
- Added the new `MiniumComponentTypes` property required by `IEntityGameObjectCreator` to the `AdvancedEntityPipeline`. [#259](https://github.com/spatialos/gdk-for-unity-fps-starter-project/pull/259)
